...
const nav = [
  ...
  { href: "/tech/hosting", icon: "🌐", label: "Website Hosting" },
  { href: "/tech/app", icon: "📱", label: "App Management" },
  { href: "/tech/models", icon: "🤖", label: "AI Models" },
  { href: "/tech/charges", icon: "💰", label: "Charges & Billing" },
];

export default function TechLayout({ children, title, subtitle }: { children: React.ReactNode; title: string; subtitle?: string }) {
      ...
      <aside className="w-64 min-h-screen bg-white border-r border-gray-100 flex flex-col fixed left-0 top-0 z-40">
        <div className="px-5 py-4 border-b border-gray-100">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-bold text-gray-900">Tech Console</div>
              <div className="text-[10px] text-gray-400">Console 01</div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 px-5 py-3">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-xs font-bold text-blue-700">T</div>
            <div>
              <div className="text-xs font-medium text-gray-800">Tech Admin</div>
              <div className="text-[10px] text-gray-400">Console 01</div>
            </div>
